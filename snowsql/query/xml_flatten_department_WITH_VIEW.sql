...
---------------VIEW-------------------------
-- view to generate the raq data from fact dimension table
CREATE 
OR REPLACE VIEW "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."EMPLOYEE_RAW" AS (
 SELECT 
  *
  FROM "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."EMPLOYEE" EMP
  INNER JOIN  "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."DEPARTMENT" DEPT ON EMP.DEPARTMENT_ID= DEPT.DEP_ID
  INNER JOIN  "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."ADDRESS" AD ON EMP.ADDRESS_ID= AD.ADD_ID
  INNER JOIN  "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."DATES" DA ON EMP.DATE_ID= DA.DAT_ID
);
SELECT * FROM "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."EMPLOYEE_RAW";

-- view to SEE EMPLOYEE WHO LIVES IN Los Angeles AND/OR CA

CREATE 
OR REPLACE VIEW "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."LOS_ANGELES_CA" AS (
 SELECT 
  EMP.EMPLOYEE_ID,EMP.FIRST_NAME,EMP.LAST_NAME,EMP.TITLE,EMP.SSN,DEPT.DEPARTMENT_NAME,AD.CITY,AD.STATE,AD.ZIP_CODE
  FROM "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."EMPLOYEE" EMP
  INNER JOIN  "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."DEPARTMENT" DEPT ON EMP.DEPARTMENT_ID= DEPT.DEP_ID
  INNER JOIN  "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."ADDRESS" AD ON EMP.ADDRESS_ID= AD.ADD_ID
  WHERE AD.CITY ='Los Angeles' AND AD.STATE='CA'
  --WHERE AD.CITY ='Los Angeles' OR AD.STATE='CA'
  
);
SELECT * FROM "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."LOS_ANGELES_CA";


-- view to SEE THE DETAILS OF DIRECTOR WHO ARE WORING ON eNGINEERING DEPARTMENT
CREATE 
OR REPLACE VIEW "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."STATE" AS (
 SELECT 
  EMP.EMPLOYEE_ID,EMP.FIRST_NAME,EMP.LAST_NAME,EMP.TITLE,EMP.SSN,DEPT.DEPARTMENT_NAME,AD.CITY,AD.STATE,AD.ZIP_CODE
  FROM "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."EMPLOYEE" EMP
  INNER JOIN  "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."DEPARTMENT" DEPT ON EMP.DEPARTMENT_ID= DEPT.DEP_ID
  INNER JOIN  "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."ADDRESS" AD ON EMP.ADDRESS_ID= AD.ADD_ID
  WHERE EMP.TITLE ='Director' AND DEPT.DEPARTMENT_NAME ='Engineering'
  
);
SELECT * FROM "FLATTEN_DATABASE"."FLATTEN_SCHEMA"."DIRECTOR";
